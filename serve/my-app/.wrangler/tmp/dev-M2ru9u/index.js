...
// .wrangler/tmp/bundle-yQXCOc/checked-fetch.js
  ...
  try {
    ...
    try {
      await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          from: "lanyinxianxuan@163.com",
          to: email,
          subject: "\u9A8C\u8BC1\u7801",
          html: `<h2>\u4F60\u7684\u9A8C\u8BC1\u7801\uFF1A${otpCode}</h2>`
        })
      });
...
// .wrangler/tmp/bundle-yQXCOc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-yQXCOc/middleware-loader.entry.ts
